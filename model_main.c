...
int model_main (int argc, char* argv[]) {
  bots_starting_positions = fopen("../../../../warehouse-CW-model/model_input/bots_starting_positions.csv", "r");
  ...
  const char *directory_path = "../../../../warehouse-CW-model/model_input/TEST3-SIMSIM";
  struct dirent *entry;
